...
\begin{frame}
  \frametitle{Padrão de circulação de vento {\bf sem} rotação}
  \begin{center}
    \includegraphics[scale=0.45]{./figures/vento_no_rotation.png}
  \end{center}
\end{frame}
...
\begin{frame}
  \frametitle{Padrão de circulação de vento {\bf com} rotação}
  \begin{center}
    \includegraphics[scale=0.45]{./figures/vento_rotation.png}
  \end{center}
\end{frame}
...
\frametitle{Dever de casa}
  ...
  \end{block}
  \begin{center}
    \includegraphics[scale=0.5]{./figures/ventos.png}
  \end{center}
\end{frame}
